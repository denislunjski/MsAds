...
import com.meritumads.databinding.MsadsWebviewSponsorDialogBinding;
import com.meritumads.settings.MsAdsSdk;
import com.meritumads.settings.MsAdsUtil;

public class MsAdsWebViewSponsorActivity extends Activity {

    private Bundle bundle;
    private String mainLink = "";
    private MsadsWebviewSponsorDialogBinding binding;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = MsadsWebviewSponsorDialogBinding.inflate(getLayoutInflater());
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            ...
            if(MsAdsUtil.isNetworkConnected(view.getContext()) == false) {
                hideErrorPage(view);
            }
        }
